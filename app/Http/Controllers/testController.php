...
class testController extends Controller
{
    ...
    {       
     ...
     //                           ->pluck('user_id')->all();
                  ...
                  //    ->get();
                 // $results = DB::select( DB::raw("SELECT `id`, `user_id`, `point`, FIND_IN_SET( `point`, (SELECT GROUP_CONCAT( `point` ORDER BY `point` DESC ) FROM reward )) AS rank FROM reward ORDER BY rank") );
                 //  dd($results);
