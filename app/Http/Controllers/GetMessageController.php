...
define('LINE_MESSAGE_CHANNEL_SECRET','f2ec57135ef2f335601fc35c3a4cba72');
define('LINE_MESSAGE_ACCESS_TOKEN','KlfKFuTJLQ/WY9URtejVZxlcL4b8EKUNVZ+0FvD48f5UUoDciqOXBRo2ByvBxmjIfmzwD2M75cotNoFp11uJf3F4mb2eChG+5LnSAbo7pQBS/fD/67DGvIAoCGhdwYYAqccxJod0zu9uvLbiVziIEAdB04t89/1O/w1cDnyilFU=');
...
//start chat
          ...
          }elseif ($userMessage == 'อาหารเช้า'){
                   
                 $case = 37;
                 $userMessage = 1;
             

          }elseif ($userMessage == 'อาหารจานเดียว'){
                   
                 $case = 37;
                 $userMessage = 2;
            
          }elseif ($userMessage== 'กับข้าว'){
                   
                 $case = 37;
                 $userMessage = 3;
           
             
          }elseif ($userMessage== 'เครื่องดื่ม'){
                   
                 $case = 37;
                 $userMessage = 4;
     
          }elseif ($userMessage == 'ผลไม้'){
                   
                 $case = 37;
                 $userMessage = 5;
          
          }elseif ($userMessage == 'อาหารว่าง'){
...
//////////////////////////////////////////////////////////////////
             ...
             }elseif ($userMessage == 'ไม่กิน [อาหารบางชนิด] กินอะไรแทนดี?' || $userMessage == 'แพ้ท้อง กินอย่างไร?'||$userMessage == 'ผลไม้ 1 ส่วนคือเท่าไร?'||$userMessage == 'ซื้ออาหารกินข้างนอก จะกะปริมาณอย่างไร?'||$userMessage == 'กินไม่ถึง หรือกินเกิน ทำอย่างไร?'||$userMessage == 'ท้องผูก ท้องอืด ทำอย่างไร?'||$userMessage == 'อื่น ๆ (ฝากคำถามไว้ได้)'||$userMessage == 'อาหารอะไรที่ควรหลีกเลี่ยง?'||$userMessage == 'ไม่อิ่ม ทำอย่างไร?' ||$userMessage == 'สัดส่วนอาหาร' ||$userMessage == 'อาการผิดปกติ' ||$userMessage == 'พัฒนาการลูกน้อย' ||$userMessage == 'การเตรียมตัวคลอด' && $sequentsteps->seqcode == '0000' ) {
              ...
              $log_message = (new SqlController)->log_message($user,$Message,$message_type);
                  ...
                  foreach($json->data as $item)
                  {
                   ...
                   $case = 1;
                   //   $userMessage  = 'ว่าไงคะ มีอะไรให้ช่วยไหมคะ';
                    $log_message = (new ReplyMessageController)->replymessage_food($replyToken,$user);
            }elseif ( $userMessage == 'ทดลอง1') {
                   $case = 1;
                   //   $userMessage  = 'ว่าไงคะ มีอะไรให้ช่วยไหมคะ';
                    $log_message = (new ReplyMessageController)->replymessage_food1($replyToken,$user);
            }else{
